...
const members = [
  ...
  },
  {
    ...
    description:
      "ดูแลความปลอดภัยของ codebase ทั้งหมด -- code security review, vulnerability scanning, OWASP Top 10, dependency audit, secrets detection และ secure architecture",
    tools: ["OWASP Top 10", "Vulnerability Scan", "Secret Detection", "Dependency Audit", "Code Review"],
    color: "via-red-400",
    isPrime: false,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
